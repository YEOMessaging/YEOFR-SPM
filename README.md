...
## Tag
example
git commit -am "YEOFR 0.1.14 – update URL + checksum"
git tag 0.1.14
git push -u origin main --tags

## Create Github Release
Open YEOMessaging/YEOFR-SPM → Releases → Draft new → Tag 0.1.14
...
Xcode → File → Packages → Update to Latest Package Versions (or pin to 0.1.14)
